...
export const MedicalProtocolsRef: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-lg overflow-hidden font-sans transition-colors">
      {/* Tab bar header */}
      <div className="bg-slate-50 dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 p-2 flex flex-wrap gap-1 transition-colors">
        <button
      ...
      <div className="p-6">
        {activeTab === 'hyper' && (
          <div className="space-y-4">
            <div className="flex items-start gap-3 bg-rose-50 dark:bg-rose-900/20 p-4 rounded-xl border border-rose-100 dark:border-rose-900/50 transition-colors">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-rose-100 text-rose-600 shrink-0">
                ⚠️
              </span>
              <div>
                <h4 className="text-sm font-black text-rose-950 dark:text-rose-200 font-sans transition-colors">Protokol Novorapid (Mulai Drip jika KGD &gt; 200)</h4>
                <p className="text-xs text-rose-800 dark:text-rose-300 mt-1 transition-colors">
            ...
            {/* Sliding Scale Grid */}
            <div className="border border-slate-100 dark:border-slate-700 rounded-xl overflow-hidden text-xs transition-colors">
              <div className="bg-slate-50 dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 grid grid-cols-2 p-3 font-bold text-slate-705 dark:text-slate-300 transition-colors">
              ...
              <div className="divide-y divide-slate-50 dark:divide-slate-700/50 transition-colors">
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                ...
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <span className="font-mono font-bold text-slate-700 dark:text-slate-300 transition-colors">3.5 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <span>301 - 350 mg/dL</span>
                  <span className="font-mono font-bold text-slate-700 dark:text-slate-300 transition-colors">3.0 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <span>251 - 300 mg/dL</span>
                  <span className="font-mono font-bold text-slate-705 dark:text-slate-300 transition-colors">2.5 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <span>201 - 250 mg/dL</span>
                  <span className="font-mono font-bold text-slate-705 dark:text-slate-300 transition-colors">2.0 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <span>151 - 200 mg/dL</span>
                  <span className="font-mono font-bold text-slate-705 dark:text-slate-300 transition-colors">1.0 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-teal-900/30 text-teal-900 dark:text-teal-400 bg-teal-50/20 dark:bg-teal-900/10 transition-colors">
                  <span>100 - 150 mg/dL</span>
                  <span className="font-mono font-bold">0.5 cc/jam</span>
                </div>
                <div className="grid grid-cols-2 p-3 hover:bg-slate-50 dark:hover:bg-amber-900/30 text-amber-900 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/10 transition-colors">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 text-xs text-slate-600 dark:text-slate-400 space-y-1 transition-colors">
              <p className="font-bold text-slate-800 dark:text-slate-200 transition-colors">Catatan Tindakan:</p>
        ...
        {activeTab === 'hypo' && (
          <div className="space-y-4">
            <div className="flex items-start gap-3 bg-sky-50 dark:bg-sky-900/20 p-4 rounded-xl border border-sky-100 dark:border-sky-900/50 transition-colors">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-sky-100 text-sky-600 shrink-0">
                💧
              </span>
              <div>
                <h4 className="text-sm font-black text-sky-950 dark:text-sky-200 transition-colors">Protokol Hipoglikemia (Ketika KGDs &lt; 70)</h4>
                <p className="text-xs text-sky-800 dark:text-sky-300 mt-1 transition-colors">
            ...
            <div className="space-y-3 font-sans text-xs">
              <div className="relative border-l-2 border-sky-200 pl-4 py-1">
                ...
                <p className="font-bold text-slate-800 dark:text-slate-200 transition-colors">Fase Koreksi Cepat (KGD &lt; 70 mg/dL)</p>
              ...
              <div className="relative border-l-2 border-sky-200 pl-4 py-1">
                <div className="absolute -left-[5px] top-2 w-2 h-2 rounded-full bg-sky-500" />
                <p className="font-bold text-slate-800 dark:text-slate-200 transition-colors">Kondisi KGD Masih Rendah</p>
                <p className="text-slate-600 dark:text-slate-400 mt-1 transition-colors">
              ...
              <div className="relative border-l-2 border-sky-100 pl-4 py-1">
                ...
                <p className="font-bold text-slate-800 dark:text-slate-200 transition-colors">Drip Pemeliharaan (KGD 70 - 100 mg/dL)</p>
                <p className="text-slate-600 dark:text-slate-400 mt-1 transition-colors">
        ...
        {activeTab === 'gcs' && (
          <div className="space-y-4">
            <div className="flex items-start gap-3 bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-100 dark:border-emerald-900/50 transition-colors">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 shrink-0">
                🧠
              </span>
              <div>
                <h4 className="text-sm font-black text-emerald-950 dark:text-emerald-200 transition-colors">Panduan Glasglow Coma Scale (GCS)</h4>
                <p className="text-xs text-emerald-800 dark:text-emerald-300 mt-1 transition-colors">
                  Skor GCS digunakan untuk mengklasifikasikan keparahan cedera otak traumatis secara seragam.
                </p>
              </div>
            </div>

            <div className="space-y-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-sans transition-colors">
            ...
            <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800/50 text-xs text-amber-950 dark:text-amber-200 flex gap-2 items-center transition-colors">
